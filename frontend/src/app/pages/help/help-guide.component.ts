  ...
  template: `
    ...
    <section id="how-to-submit" class="py-5">
      <div class="container">
        ...
        <!-- AI Copilot callout -->
        <div class="alert border-0 shadow-sm d-flex gap-3 align-items-start"
             style="background:linear-gradient(135deg,rgba(123,47,247,.07),rgba(33,150,243,.07));">
